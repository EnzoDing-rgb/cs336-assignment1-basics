#!/usr/bin/env python3
"""SwiGLU vs SiLU：一张 valid-loss 学习曲线.

  uv run python scripts/plot_ffn.py
"""
...
OUT = ROOT / "artifacts" / "plots" / "ffn" / "swiglu_vs_silu_valid.png"

RUNS = (
    ("tinystories_swiglu_b64_lr1.8e-3", "SwiGLU", "#3182bd"),
    ("tinystories_silu_b64_lr1.8e-3", "SiLU", "#e6550d"),
)
...
def main() -> None:
    ...
    ax.set_title("SwiGLU vs SiLU · valid loss（B=64, lr_max=1.8e-3, 20k steps）")
    ax.set_xlabel("step")
